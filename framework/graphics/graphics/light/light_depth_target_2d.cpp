...
namespace vg
{
    LightDepthTarget2D::LightDepthTarget2D(uint32_t framebufferWidth
    ...
    const Texture2DDepthAttachment *LightDepthTarget2D::getDepthTargetTexture() const
    {
        return m_pDepthTargetTex.get();
    }

    void LightDepthTarget2D::_createObjs()
    {
