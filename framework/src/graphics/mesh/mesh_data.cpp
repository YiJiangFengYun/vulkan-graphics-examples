...
namespace kgs
{
	...
	void MeshData::memCopyDataValue(std::string name, DataType dataType, void* dst, uint32_t offset, uint32_t maxElementCount)
	{
		...
		{
			auto arr = getValue(name, mapFloatArrays, arrFloatArrays, KGS_TRUE);
			std::memcpy(ptr, arr.data(), sizeof(DataTypeInfo<DataType::FLOAT_ARRAY>::BaseType) * std::min(static_cast<uint32_t>(arr.size()), maxElementCount));
			break;
		}
		case DataType::INT:
		{
		...
		{
			auto arr = getValue(name, mapIntArrays, arrIntArrays, KGS_TRUE);
			std::memcpy(ptr, arr.data(), sizeof(DataTypeInfo<DataType::INT_ARRAY>::BaseType) * std::min(static_cast<uint32_t>(arr.size()), maxElementCount));
			break;
		}
		case DataType::VECTOR_2:
		{
		...
		{
			auto arr = getValue(name, mapVector2Arrays, arrVector2Arrays, KGS_TRUE);
			std::memcpy(ptr, arr.data(), sizeof(DataTypeInfo<DataType::VECTOR_2_ARRAY>::BaseType) * std::min(static_cast<uint32_t>(arr.size()), maxElementCount));
			break;
		}
		case DataType::VECTOR_3:
		{
		...
		{
			auto arr = getValue(name, mapVector3Arrays, arrVector3Arrays, KGS_TRUE);
			std::memcpy(ptr, arr.data(), sizeof(DataTypeInfo<DataType::VECTOR_3_ARRAY>::BaseType) * std::min(static_cast<uint32_t>(arr.size()), maxElementCount));
			break;
		}
		case DataType::VECTOR_4:
		{
		...
		{
			auto arr = getValue(name, mapVector4Arrays, arrVector4Arrays, KGS_TRUE);
			std::memcpy(ptr, arr.data(), sizeof(DataTypeInfo<DataType::VECTOR_4_ARRAY>::BaseType) * std::min(static_cast<uint32_t>(arr.size()), maxElementCount));
			break;
		}
		case DataType::COLOR_32:
		{
		...
		{
			auto arr = getValue(name, mapColor32Arrays, arrColor32Arrays, KGS_TRUE);
			std::memcpy(ptr, arr.data(), sizeof(DataTypeInfo<DataType::COLOR_32_ARRAY>::BaseType) * std::min(static_cast<uint32_t>(arr.size()), maxElementCount));
			break;
		}
		default:
